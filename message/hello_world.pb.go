...
type HelloRequest struct {
	Request string `protobuf:"bytes,1,opt,name=request" json:"request"`
}
...
type HelloResponse struct {
	Response string `protobuf:"bytes,1,opt,name=response" json:"response"`
}

func (m *HelloResponse) Reset()                    { *m = HelloResponse{} }
func (m *HelloResponse) String() string            { return proto.CompactTextString(m) }
func (*HelloResponse) ProtoMessage()               {}
func (*HelloResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (c *helloServiceClient) HelloWorld(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := grpc.Invoke(ctx, "/proto.HelloService/HelloWorld", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) HelloWorldServerStream(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (HelloService_HelloWorldServerStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_HelloService_serviceDesc.Streams[0], c.cc, "/proto.HelloService/HelloWorldServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloServiceClient) HelloWorldClientStream(ctx context.Context, opts ...grpc.CallOption) (HelloService_HelloWorldClientStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_HelloService_serviceDesc.Streams[1], c.cc, "/proto.HelloService/HelloWorldClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloServiceClient) HelloWorldClientAndServerStream(ctx context.Context, opts ...grpc.CallOption) (HelloService_HelloWorldClientAndServerStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_HelloService_serviceDesc.Streams[2], c.cc, "/proto.HelloService/HelloWorldClientAndServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("hello_world.proto", fileDescriptor3) }
